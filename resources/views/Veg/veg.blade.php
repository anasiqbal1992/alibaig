    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Veg Items</h3>
         ...
         @endif
        <div class="card-body">
            <a href="{{ URL('add_veg')}}" class="btn btn-primary"><span class="fa fa-plus fa-lg"></span><span> Veg Item</span></a>
         <table class="table table-striped table-valign-middle">
                  ...
                  <tr id="product{{$element->id}}">
                    ...
                    <td><a href="{{URL:: asset('edit_veg/'.$element->id)}}" class="btn btn-info"><span class="fa fa-pencil fa-lg"></span><span> Edit</span></a>
