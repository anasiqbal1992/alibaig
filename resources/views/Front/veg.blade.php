            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-footer">
                    <input type="hidden" value="{{$items->price}}" id="tprice_{{ $items->id }}"/>
                 ...
                 <a  data-id="{{$items->id}}" field='updates_{{$items->id }}' tprice="tprice_{{ $items->id }}" price="price_{{ $items->id }}" class="btn btn-info btn-cart"><span class="fa fa-shopping-basket fa-lg"></span><span> Add to basket</span></a>
                </div>
              </div>
            </div>
              @endforeach
