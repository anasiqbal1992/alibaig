...
class VegitemController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function Veg_add()
    {
        //
         return view("Veg/addveg");
        
    }
    
     public function Veg_save(Request $request)
	{
     ...
     * @return \Illuminate\Http\Response
     */
    public function Veg_edit($id)
    {
        //
        $data = menu::findornew($id);
        return view("Veg/editveg", ['data' => $data,'id'=> $id]);
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function Veg_update(Request $request, $id)
    {
        //
     //   $data = new menu();
         $data = menu::find($id);
		...
		$image->move($destinationPath,$filename);
			 ...
			 $data->image = $image_old;
              ...
              return redirect("veg")->with('success', 'Updated Successfully');
    }
