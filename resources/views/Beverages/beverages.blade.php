    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
         ...
         @endif
        <div class="card-body">
         <a href="{{ URL('add_beverages')}}" class="btn btn-primary"><span class="fa fa-plus fa-lg"></span><span><strong> Beverages</strong></span></a>
                ...
                <table class="table table-striped table-valign-middle">
                  ...
                  <tr id="product{{$element->id}}">
                    ...
                    <td>{{$element->title}}</td>
                    <td>{{$element->price}}</td>
                    <td><a href="{{URL:: asset('edit_beverages/'.$element->id)}}"class="btn btn-info"><span class="fa fa-edit fa-lg"></span><span> Edit</span></a>
